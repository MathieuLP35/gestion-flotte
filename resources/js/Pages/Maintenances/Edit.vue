<template>
    <Head title="Edition d'une maintenance" />
          ...
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 md:p-8">
              <h1 class="text-3xl font-bold text-gray-800 mb-6">
                Modifier le seuil de maintenance
              </h1>
...
const form = useForm({
  ...
  km_alert_threshold: maintenance.km_alert_threshold,
  date_dernier_entretien: maintenance.date_dernier_entretien ?? '',
})
